...
.method public calculateMac(JS[BII)[B
    ...
    .line 113
    invoke-static {p3, v2, p1}, Lorg/spongycastle/crypto/tls/TlsUtils;->writeUint8(S[BI)V
    ...
    .line 116
    invoke-static {v0, v2, p1}, Lorg/spongycastle/crypto/tls/TlsUtils;->writeVersion(Lorg/spongycastle/crypto/tls/ProtocolVersion;[BI)V
    ...
    invoke-static {p6, v2, p1}, Lorg/spongycastle/crypto/tls/TlsUtils;->writeUint16(I[BI)V
    ...
    invoke-interface {p1, v2, v3, p2}, Lorg/spongycastle/crypto/Mac;->update([BII)V
    ...
    invoke-interface {p2, p1, v3}, Lorg/spongycastle/crypto/Mac;->doFinal([BI)I
