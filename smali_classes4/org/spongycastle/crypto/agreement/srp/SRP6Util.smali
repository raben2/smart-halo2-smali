...
.method public static calculateX(Lorg/spongycastle/crypto/Digest;Ljava/math/BigInteger;[B[B[B)Ljava/math/BigInteger;
    ...
    invoke-interface {p0, p4, v1, p3}, Lorg/spongycastle/crypto/Digest;->update([BII)V

    .line 32
    invoke-interface {p0, p1, v1}, Lorg/spongycastle/crypto/Digest;->doFinal([BI)I

    .line 34
    array-length p3, p2

    invoke-interface {p0, p2, v1, p3}, Lorg/spongycastle/crypto/Digest;->update([BII)V

    .line 35
    array-length p2, p1

    invoke-interface {p0, p1, v1, p2}, Lorg/spongycastle/crypto/Digest;->update([BII)V
