...
.method private static implSTRandomPrime(Lorg/spongycastle/crypto/Digest;I[B)Lorg/spongycastle/math/Primes$STOutput;
    ...
    .line 488
    :goto_0
    invoke-static {v0, v2, v7, v5}, Lorg/spongycastle/math/Primes;->hash(Lorg/spongycastle/crypto/Digest;[B[BI)V

    .line 489
    invoke-static {v2, v6}, Lorg/spongycastle/math/Primes;->inc([BI)V

    .line 491
    invoke-static {v0, v2, v3, v5}, Lorg/spongycastle/math/Primes;->hash(Lorg/spongycastle/crypto/Digest;[B[BI)V

    .line 492
    invoke-static {v2, v6}, Lorg/spongycastle/math/Primes;->inc([BI)V

    .line 494
    invoke-static {v7}, Lorg/spongycastle/math/Primes;->extract32([B)I
    ...
    .line 501
    invoke-static {v9, v10}, Lorg/spongycastle/math/Primes;->isPrime32(J)Z
    ...
    invoke-direct {v0, v1, v2, v8, v4}, Lorg/spongycastle/math/Primes$STOutput;-><init>(Ljava/math/BigInteger;[BILorg/spongycastle/math/Primes$1;)V
    ...
    invoke-static {v0, v7, v2}, Lorg/spongycastle/math/Primes;->implSTRandomPrime(Lorg/spongycastle/crypto/Digest;I[B)Lorg/spongycastle/math/Primes$STOutput;
    ...
    .line 524
    invoke-static {v0, v8, v3}, Lorg/spongycastle/math/Primes;->hashGen(Lorg/spongycastle/crypto/Digest;[BI)Ljava/math/BigInteger;
    ...
    .line 556
    sget-object v5, Lorg/spongycastle/math/Primes;->THREE:Ljava/math/BigInteger;

    invoke-virtual {v12, v5}, Ljava/math/BigInteger;->subtract(Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    sget-object v15, Lorg/spongycastle/math/Primes;->TWO:Ljava/math/BigInteger;
    ...
    .line 561
    invoke-virtual {v5, v13, v12}, Ljava/math/BigInteger;->modPow(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    invoke-virtual {v5, v7, v12}, Ljava/math/BigInteger;->modPow(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    invoke-direct {v0, v12, v8, v10, v4}, Lorg/spongycastle/math/Primes$STOutput;-><init>(Ljava/math/BigInteger;[BILorg/spongycastle/math/Primes$1;)V
    ...
    .line 570
    :cond_5
    invoke-static {v8, v3}, Lorg/spongycastle/math/Primes;->inc([BI)V
