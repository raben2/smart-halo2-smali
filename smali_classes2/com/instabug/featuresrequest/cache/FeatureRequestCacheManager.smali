...
.method public static getCache()Lcom/instabug/library/internal/storage/cache/InMemoryCache;
    ...
    const-string v1, "In-memory features requet cache not found, loading it from disk "
    ...
    const-string v1, "FeatureRequestCacheManager"
    ...
    new-instance v1, Lcom/instabug/featuresrequest/cache/FeatureRequestCacheManager$a;

    invoke-direct {v1}, Lcom/instabug/featuresrequest/cache/FeatureRequestCacheManager$a;-><init>()V

    const-string v2, "features_request_disk_cache"

    const-string v3, "features_request_memory_cache"
    ...
    const-string v2, "In-memory Feature Request cache restored from disk, "
    ...
    :cond_0
    const-string v0, "FeatureRequestCacheManager"

    const-string v1, "In-memory features request cache found"
...
.method public static getExtrasCache()Lcom/instabug/library/internal/storage/cache/InMemoryCache;
    ...
    const-string v1, "In-memory features request extas cache not found, loading it from disk "
    ...
    new-instance v1, Lcom/instabug/featuresrequest/cache/FeatureRequestCacheManager$c;

    invoke-direct {v1}, Lcom/instabug/featuresrequest/cache/FeatureRequestCacheManager$c;-><init>()V

    const-string v2, "features_request_extras_disk_cache"

    const-string v3, "features_request_extras_memory_cache"
    ...
    const-string v2, "In-memory Feature Request extras cache restored from disk, "
    ...
    const-string v1, "In-memory features request extras cache found"
...
.method public static saveCacheToDisk()V
    ...
    const-string v3, "Saving In-memory feature requests cache to disk, no. of feature requests to save is "
    ...
    new-instance v3, Lcom/instabug/featuresrequest/cache/FeatureRequestCacheManager$b;

    invoke-direct {v3}, Lcom/instabug/featuresrequest/cache/FeatureRequestCacheManager$b;-><init>()V
    ...
    const-string v2, "In-memory feature requests cache had been persisted on-disk, "
...
.method public static saveExtrasCacheToDisk()V
    ...
    const-string v3, "Saving In-memory feature requests extras cache to disk, no. of feature requests to save is "
    ...
    new-instance v3, Lcom/instabug/featuresrequest/cache/FeatureRequestCacheManager$d;

    invoke-direct {v3}, Lcom/instabug/featuresrequest/cache/FeatureRequestCacheManager$d;-><init>()V
    ...
    const-string v2, "In-memory feature requests extras cache had been persisted on-disk, "
