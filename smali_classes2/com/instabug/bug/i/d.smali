.class public Lcom/instabug/bug/i/d;
...
.method private d(Landroid/content/Context;)V
    ...
    .line 1
    invoke-static {p1}, Lcom/instabug/bug/d;->c(Landroid/content/Context;)Landroid/content/Intent;
...
.method public a(Landroid/content/Context;)Lcom/instabug/library/core/plugin/PluginPromptOption;
    ...
    .line 6
    invoke-virtual {p0, p1}, Lcom/instabug/bug/i/d;->c(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 7
    invoke-virtual {p0, p1}, Lcom/instabug/bug/i/d;->b(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 8
    new-instance v2, Lcom/instabug/bug/i/d$a;

    invoke-direct {v2, p0, p1}, Lcom/instabug/bug/i/d$a;-><init>(Lcom/instabug/bug/i/d;Landroid/content/Context;)V
...
.method protected varargs a(Landroid/content/Context;Landroid/net/Uri;[Ljava/lang/String;)V
    ...
    const-string v0, "FeedbackPromptItem"

    const-string v1, "Handle invocation request new feedback"
    ...
    .line 32
    invoke-direct {p0, p1}, Lcom/instabug/bug/i/d;->d(Landroid/content/Context;)V
...
.method b(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 1
    sget-object v0, Lcom/instabug/library/InstabugCustomTextPlaceHolder$Key;->REPORT_FEEDBACK_DESCRIPTION:Lcom/instabug/library/InstabugCustomTextPlaceHolder$Key;
    ...
    sget v2, Lcom/instabug/bug/R$string;->ib_bug_report_feedback_description:I
...
.method c(Landroid/content/Context;)Ljava/lang/String;
    ...
    sget v2, Lcom/instabug/bug/R$string;->instabug_str_feedback_header:I
