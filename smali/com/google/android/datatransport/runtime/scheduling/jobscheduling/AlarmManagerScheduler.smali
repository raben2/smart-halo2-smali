...
.method public schedule(Lcom/google/android/datatransport/runtime/TransportContext;I)V
    ...
    invoke-virtual {v0, v5, v3, v4, p2}, Lcom/google/android/datatransport/runtime/scheduling/jobscheduling/SchedulerConfig;->getScheduleDelay(Lcom/google/android/datatransport/Priority;JI)J

    move-result-wide v5

    const-string v0, "AlarmManagerScheduler"

    const-string v7, "Scheduling upload for context %s in %dms(Backend next call timestamp %d). Attempt %d"
    ...
    .line 111
    invoke-static {v0, v7, v8}, Lcom/google/android/datatransport/runtime/logging/Logging;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
